...
flexWrap: "wrap", gap: 8, flexWrap: "wrap" }}>
          ...
          <div style={{ marginTop: 22, padding: "clamp(20px, 5vw, 50px)", borderRadius: 14, background: "#060c18", border: "1px solid #22d3ee1a", opacity: visible ? 1 : 0, transition: "opacity 1.2s 0.8s" }}>
